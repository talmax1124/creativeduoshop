...
const RegisterScreen = ({ location, history }) => {
  ...
  return (
    <div className="register-screen">
      <div className="register-screen-left">
        <img
          src="https://images.pexels.com/photos/7661331/pexels-photo-7661331.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
          alt="Login-Alt-Image"
        />
      </div>
      <div className="register-screen-right">
        ...
        <Row className="py-3">
          <Col className="flex">
            <p className="font-medium mr-2">Have an account?</p>
            <Link
